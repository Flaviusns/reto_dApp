...
near call $dev_account_put_yours create_raffle '{"description": "Concurso de prueba", "min_entry_price":1, "min_participants": 1, "prize": "hash_1"}' --accountId $dev_account_put_yours create_raffle --amount 10
```
